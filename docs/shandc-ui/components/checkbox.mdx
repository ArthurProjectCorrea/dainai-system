...
<ComponentPreview styleName="radix-nova" name="checkbox-demo" previewClassName="h-80" />
...
<ComponentSource name="checkbox" title="components/ui/checkbox.tsx" styleName="radix-nova" />
...
<ComponentPreview styleName="radix-nova" name="checkbox-table" previewClassName="p-4 md:p-8" />
