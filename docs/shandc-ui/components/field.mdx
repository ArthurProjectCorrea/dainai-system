...
<ComponentSource name="field" title="components/ui/field.tsx" styleName="radix-nova" />
...
<ComponentPreview styleName="radix-nova" name="field-checkbox" previewClassName="h-[32rem]" />
...
<ComponentPreview styleName="radix-nova" name="field-group" previewClassName="h-96" />
