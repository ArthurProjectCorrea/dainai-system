...
<ComponentSource name="chart" title="components/ui/chart.tsx" styleName="radix-nova" />
...
<ComponentPreview styleName="radix-nova" name="chart-example" previewClassName="h-80" />
...
<ComponentPreview styleName="radix-nova" name="chart-example-grid" previewClassName="h-80" />
...
<ComponentPreview styleName="radix-nova" name="chart-example-axis" previewClassName="h-80" />
...
<ComponentPreview styleName="radix-nova" name="chart-example-tooltip" previewClassName="h-80" />
...
<ComponentPreview styleName="radix-nova" name="chart-example-legend" previewClassName="h-80" />
