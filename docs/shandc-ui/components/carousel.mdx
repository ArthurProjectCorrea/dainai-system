...
<ComponentSource name="carousel" title="components/ui/carousel.tsx" styleName="radix-nova" />
...
<ComponentPreview styleName="radix-nova" name="carousel-orientation" previewClassName="h-[32rem]" />
...
<ComponentPreview styleName="radix-nova" name="carousel-api" previewClassName="sm:h-[32rem]" />
...
<ComponentPreview styleName="radix-nova" name="carousel-plugin" previewClassName="sm:h-[32rem]" />
