...
<Callout>
  For form fields, use the [Field](/docs/components/radix/field) component which includes built-in
  label, description, and error handling.
</Callout>
...
<ComponentSource name="label" title="components/ui/label.tsx" styleName="radix-nova" />
...
<ComponentPreview styleName="radix-nova" name="field-demo" previewClassName="h-[44rem]" />
