...
<ComponentPreview styleName="radix-nova" name="table-demo" previewClassName="h-[30rem]" />
...
<ComponentSource name="table" title="components/ui/table.tsx" styleName="radix-nova" />
