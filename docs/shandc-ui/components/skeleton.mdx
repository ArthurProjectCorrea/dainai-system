...
<ComponentSource name="skeleton" title="components/ui/skeleton.tsx" styleName="radix-nova" />
...
<ComponentPreview styleName="radix-nova" name="skeleton-card" previewClassName="h-80" />
