...
<ComponentSource name="pagination" title="components/ui/pagination.tsx" styleName="radix-nova" />
...
<ComponentPreview styleName="radix-nova" name="pagination-rtl" direction="rtl" />
