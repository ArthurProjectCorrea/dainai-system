...
<figure className="flex flex-col gap-4">
  <ComponentPreview styleName="radix-nova" name="sidebar-demo" type="block" className="w-full" />
...
<ComponentSource name="sidebar" title="components/ui/sidebar.tsx" styleName="radix-nova" />
