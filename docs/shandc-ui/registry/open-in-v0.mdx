...
<Callout className="mt-6">
  **Important:** `Open in v0` does not support `cssVars`, `css`, `envVars`, namespaced registries,
  or advanced authentication methods.
</Callout>
...
<Callout className="mt-6">
  **Security Note:** Make sure to encrypt and expire tokens. Never expose production tokens in
