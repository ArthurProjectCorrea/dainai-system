...
<Callout className="">
  **Update:** We have added full support for React 19 and Tailwind v4 in the `latest` release.
  **This guide might be outdated. Proceed with caution.**
</Callout>
...
<Callout>**Note:** This is npm only. PNPM and Bun will only show a silent warning.</Callout>
